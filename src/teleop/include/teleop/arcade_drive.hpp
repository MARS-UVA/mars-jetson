...
public:
    ...
    ArcadeDrive(const bool& invert_linear, const bool& invert_turn, const bool& square_inputs, const Deadband& deadband)
    : _invert_linear(invert_linear), _invert_turn(invert_turn), _square_inputs(square_inputs), _deadband(deadband) {}
    ...
    const Deadband& deadband() const { return _deadband; }
    Deadband& deadband() { return _deadband; }
